      ...
      <div className="area-navs" id='topheader'>
        ...
        <ul className="nav nav-tabs">
          <li className="nav-item">
            <a id='opt1' className="nav-link" onClick={() => setVision(0)}>Visão geral</a>
          </li>
          <li className="nav-item">
            <a id='opt2' className="nav-link" onClick={() => setVision(1)}>Pipelines</a>
          </li>
          <li className="nav-item">
            <a id='opt3' className="nav-link" onClick={() => setVision(2)}>Câmeras</a>
          </li>
          <li className="nav-item">
            <a id='opt4' className="nav-link" onClick={() => setVision(3)}>Mosaicos das câmeras</a>
          </li>
        ...
        {vision === 0 ? (
          <div className="vision">
            ...
            <span>Bem-vindo ao Guia do CameraPipeline. Neste capítulo, apresentaremos os fundamentos do CameraPipeline, 
              incluindo informações básicas sobre por que fundamos e uma visão geral das funcionalidades do sistema.
            </span>
          </div>
        ): vision === 1 ? (
          <div className="vision">
