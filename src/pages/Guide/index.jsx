        ...
        {vision === 0 ? (
          <div className="vision">
            ...
            <p>
              ...
              instruções para vários processos serem organizados
            ...
            <p>
              Navegue pelas abas do guia para saber detalhadamente como utilizar
          ...
          <div className="vision">
            ...
            <br />
            <p>
              1 - No menu do sistema clique em Pipelines, no menu de Pipelines,
              clique em Criar nova, escolha um nome e clique em salvar.
              <br /> Em seguida voce será redirecionado para a tela de edição da
              nova pipeline
            </p>
            <p>
              2 - Na edição de pipeline, clique nas PDIs cadastradas que você
              deseja adicionar para que ela seja aplicada na lista de processos
              que serão utilizados na imagem (a ordem do processo é feita no
              fluxo de pipeline, há uma aba exclusiva para ela no guia)
            </p>
            <div className="image-guide">
              <img
                className="guide-shadow m-3"
            ...
            <p>
              ...
              desejar, faça isso para todos os processos aplicados na pipeline e
              salve para finalizar a pipeline
            </p>
            <div className="image-guide">
              <img
                className="guide-shadow m-3"
            ...
            <br />
            <p>
              extra - É possivel editar, ver o historico e restaurar a versao de
              uma pipeline{" "}
            </p>
            <div className="image-guide">
              <img
          ...
          <div className="vision">
            ...
            <br />
            <p>
              O fluxo de pipeline é onde será criado uma ordem de processos para
            ...
            <p>
              2 - Conecte um processo em outro para definir a ordem (a saída da
              pipeline serão os processos que não possuem filhos na ediçao do
              fluxo)
            </p>
            <p>
          ...
          <div className="vision">
            ...
            <p>
              3 - selecione a pipeline que deseja ser aplicada à imagem e verá o
            ...
            <p>
              3 - selecione a pipeline que deseja ser aplicada ao vídeo e verá o
              resultado da imagem processada sobre o video.
            </p>
            <br />
            ...
            <p>
              3 - selecione a pipeline que deseja ser aplicada à imagem e verá o
              resultado da imagem processada sobre a câmera.
            </p>
            <br />
          </div>
        ) : null}
